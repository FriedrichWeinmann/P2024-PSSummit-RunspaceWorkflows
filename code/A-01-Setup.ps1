...
<#
Steps to implementing Runspaces:

+ Define initial session state
  + Add contents (variables, functions, modules, etc.) as needed
+ Define and configure runspacepool
+ Define runspaces
  + Assign to pool
  + Start Runspace
+ Wait until completed and collect results
+ Cleanup

Simple guide to your first runspace:
https://blog.netnerds.net/2016/12/runspaces-simplified/
@cl (Chrissy LeMaire)
#>

# Continue: Next
code "$presentationRoot\A-02-Queues.ps1"
